...
const topEmployees = [
  { name: "Босс", dept: "5 группа", tasks: 24, kpi: 97 },
  { name: "Такракан архивариус", dept: "5 группа ", tasks: 21, kpi: 94 },
  { name: "Дритатун", dept: "5 группа", tasks: 19, kpi: 91 },
];

const recentRequests = [
  {
    id: "175/452/14/56",
    title: "Проведение УПО",
    priority: "high",
    status: "В работе",
    assignee: "ИД",
  },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {/* Bar Chart */}
        <div
          className="col-span-2 rounded-lg border border-border p-5"
          style={{ background: "hsl(var(--card))" }}
        >
        ...
        >
          ...
          <div className="space-y-3">
            {[
              { name: "5 группа", load: 89, tasks: 18 },
              { name: "2 группа", load: 75, tasks: 14 },
              { name: "3 группа", load: 62, tasks: 11 },
              { name: "4 группа", load: 45, tasks: 8 },
              { name: "1 группа", load: 38, tasks: 7 },
            ].map((dept) => (
              <div key={dept.name}>
              ...
              <div key={req.id} className="px-5 py-3 flex items-center gap-3">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <span
                    ...
                    style={{
                      background: `${statusColors[req.status]}18`,
