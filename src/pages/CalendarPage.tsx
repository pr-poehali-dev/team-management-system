...
const TASKS: Task[] = [
  ...
  {
    id: 3,
    title: "Планёрка технического отдела",
    date: 10,
    type: "meeting",
    assignee: "Все",
    time: "09:30",
  ...
  {
    id: 4,
    title: "Установка оборудования REQ-2501",
    date: 10,
    type: "task",
    assignee: "ИД",
    time: "14:00",
  ...
  {
    id: 5,
    title: "Демо VPN для воинской части",
    date: 15,
    type: "meeting",
    assignee: "КП",
    time: "11:00",
  ...
  {
    id: 7,
    title: "Оплата лицензий MS Office",
    date: 20,
    type: "task",
    assignee: "СА",
    time: "12:00",
  ...
  {
    id: 9,
    title: "Инструктаж новых сотрудников",
    date: 12,
    type: "task",
    assignee: "ПО",
    time: "10:00",
    ...
    <div className="flex gap-4 h-full">
                      ...
                      <div className="space-y-0.5">
                        {dayTasks.slice(0, 2).map((t) => (
                          <div
                            ...
                            style={{
                              background: typeConfig[t.type].bg,
              ...
              selectedTasks.map((task) => (
                <div key={task.id} className="px-4 py-3">
                  <div className="flex items-start gap-2">
                    <div
                      className="w-1 h-full rounded mt-1 flex-shrink-0 self-stretch"
                      style={{
                        background: typeConfig[task.type].color,
                        minHeight: "40px",
                      }}
                    />
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span
                          ...
                          style={{
                            background: typeConfig[task.type].bg,
          ...
          <div className="divide-y divide-border">
            {TASKS.filter((t) => t.date >= today)
              ...
              .map((task) => (
                <div
                  key={task.id}
                  className="px-4 py-2.5 flex items-center gap-3 hover:bg-secondary/30 transition-colors cursor-pointer"
      ...
      {showAddTask && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget) setShowAddTask(false);
          }}
        >
          <div
            className="rounded-xl border border-border w-full max-w-md p-6 space-y-4 animate-slide-up"
            style={{ background: "hsl(var(--card))" }}
          >
